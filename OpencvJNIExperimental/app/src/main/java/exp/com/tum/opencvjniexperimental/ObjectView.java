...
import static exp.com.tum.opencvjniexperimental.Useful.GetTime;
            ...
            if (TheObject != null)
              {
                ...
                gl.glTranslatef
                  (- (TheObject.BoundMax.x + TheObject.BoundMin.x) / 2.0f, - (TheObject.BoundMax.y + TheObject.BoundMin.y) / 2.0f,
                    - (TheObject.BoundMax.z + TheObject.BoundMin.z) / 2.0f
                  );
                gl.glFrontFace(ClockwiseFaces ? gl.GL_CW : gl.GL_CCW);
                TheObject.Draw();
              } /*if*/
          } /*onDrawFrame*/

        public void onSurfaceChanged(GL10 _gl, int ViewWidth, int ViewHeight)
          {
...
//            gl.glFrustumf(-ratio,ratio,-1,1,1,10);
        ...
        public void onSurfaceCreated(GL10 _gl, javax.microedition.khronos.egl.EGLConfig Config)
          {
    ...
    public ObjectView(android.content.Context TheContext, android.util.AttributeSet TheAttributes)
      {
    ...
    public void SetOrientation(Rotation NewOrientation, android.view.animation.Interpolator AnimFunction, /* optional */
