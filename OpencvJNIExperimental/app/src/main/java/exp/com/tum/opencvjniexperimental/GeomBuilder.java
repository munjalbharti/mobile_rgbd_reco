  ...
  */
  {
    ...
    public GeomBuilder(boolean GotNormals, /* vertices will have normals specified, otherwise they will be automatically generated for flat shading */boolean GotTexCoords, /* vertices will have texture coordinates specified */
    ...
    private int Add(Vec3f Vertex,/* following args are either mandatory or must be null, depending
        on respective flags passed to constructor */Vec3f Normal, Vec3f TexCoord, Color VertexColor,
        boolean AutoNormals)
      /* adds a new vertex, and returns its index for use in constructing faces. */
      {
        if
          (AutoNormals != (Normal == null) || (PointColors == null) != (VertexColor == null) ||
    ...
    public static class Obj
      /* representation of complete object geometry. */
      {
        ...
        private Obj(IntBuffer VertexBuffer, IntBuffer NormalBuffer, /* optional */IntBuffer TexCoordBuffer, /* optional */
            IntBuffer ColorBuffer, /* optional */ShortBuffer IndexBuffer, int NrIndexes, Vec3f BoundMin,
            Vec3f BoundMax)
          {
