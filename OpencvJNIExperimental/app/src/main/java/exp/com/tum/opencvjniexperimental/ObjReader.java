...
import static exp.com.tum.opencvjniexperimental.GLUseful.gl;
...
public class ObjReader
  {
    ...
    private static class ObjTokenizer
      {
        ...
        public Vec3f GetVec(int MinD, /* [1 .. 3] */int MaxD /* [3 .. 4] */
          ) {
    ...
    public static Model ReadMesh(Mesh mesh) throws DataFormatException{

      ArrayList<Vec3f> Vertices = mesh.getVertices();
      ArrayList<Vec3f> TexCoords = mesh.getTexCoords();
      ArrayList<Vec3f> Normals = mesh.getNormals();

      ArrayList<FaceVert[]> Faces = mesh.getFaces();
      ...
      if (Faces != null)
          {
            ...
            final GeomBuilder Geom = new GeomBuilder(Normals != null, TexCoords != null, false);
            ...
            for (FaceVert[] Face : Faces)
            {
              for (FaceVert Vert : Face)
              {
                ...
                {
                  FaceMap.put(Vert, Geom.Add(Vertices.get(Vert.VertIndex-1), (Vert.NormalIndex != null && Normals!= null) ? Normals.get(Vert.NormalIndex-1) : null,
                          (Vert.TexCoordIndex != null && TexCoords!= null) ? TexCoords.get(Vert.TexCoordIndex-1) : null, null));

//                  FaceMap.put(Vert, Geom.Add(Vertices.get(Vert.VertIndex), Vert.NormalIndex != null ? Normals.get(Vert.NormalIndex) : null,
  //                        Vert.TexCoordIndex != null ? TexCoords.get(Vert.TexCoordIndex) : null, null));
            ...
            if (BoundMin != null) {
              BoundMin = new Vec3f(Math.min(BoundMin.x, NewObj.BoundMin.x), Math.min(BoundMin.y, NewObj.BoundMin.y),
            ...
            if (BoundMax != null) {
              BoundMax = new Vec3f(Math.max(BoundMax.x, NewObj.BoundMax.x), Math.max(BoundMax.y, NewObj.BoundMax.y),
            ...
            ModelComponents.add(new Model.Component(CurMaterial, NewObj));
            Faces = null;
      ...
      return new Model(ModelComponents.toArray(new Model.Component[ModelComponents.size()]), BoundMin,
                              BoundMax);
    }
    ...
    throws DataFormatException
      {
        ...
        ArrayList<Vec3f> Vertices = null, TexCoords = null, Normals = null;
    ...
    public static Mesh ReadObjAndReturnMesh(java.io.InputStream From, MaterialLoader LoadMaterials)
            throws DataFormatException
    {
      final ObjTokenizer Parse = new ObjTokenizer(From);
      ArrayList<Vec3f> Vertices = null, TexCoords = null, Normals = null;
      ...
      final ArrayList<Model.Component> ModelComponents = new ArrayList<Model.Component>();
      Material CurMaterial = new Material("");
      Vec3f BoundMin = null, BoundMax = null;
      Mesh mesh=new Mesh();
      for (;;)
      {
        String Op = Parse.NextSym(false);
    ...
    public static Mesh ReadObjAndReturnMesh(String FileName, MaterialLoader LoadMaterials)
            throws DataFormatException
    {
      Mesh Result = null;
      ...
      if (ReadFrom != null)
      {
        Result = ReadObjAndReturnMesh(ReadFrom, LoadMaterials);
        try
        {
          ReadFrom.close();
        }
