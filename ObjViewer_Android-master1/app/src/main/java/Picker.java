        ...
        PickerList.clear();
          {
            final String ExternalStorage =
              ...
              System.out.print("ExternalStorage::  "+ExternalStorage);
              String Extension = getIntent().getStringExtra(ExtensionID);
              Extension=".obj";
              System.out.print("bharti::  "+Extension);
              System.out.print(Extension);

            for (String Here : new String[]
                    {
                            "Models",
                            "Download",
                   })
              {
                ...
                final java.io.File ThisDir = new java.io.File
                  ...
                  System.out.print( "Absolute path of"+ThisDir.getAbsolutePath());

                if (ThisDir.isDirectory())
                  {
                      System.out.println("Is a directory..will list directory now");
                      java.io.File[] all_files=ThisDir.listFiles();

                      System.out.println("Files list is " +all_files);

                      for (java.io.File Item : all_files )
                      {
